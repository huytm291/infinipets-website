...
export default function Index() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      {/* Limited Edition */}
      <section className={`py-20 ${isDarkMode ? 'bg-gradient-to-br from-purple-900 to-pink-900' : 'bg-gradient-to-br from-purple-50 to-pink-50'}`}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="font-coiny text-4xl md:text-5xl mb-4 text-gradient">
      ...
      {/* Newsletter Section - Updated with better colors */}
          ...
          <div className="max-w-3xl mx-auto">
            <div className="mb-6">
              <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-4">
                ...
                <span className="text-sm font-medium text-white">Join 50,000+ Pet Parents</span>
              </div>
            </div>
            
            <h2 className="font-coiny text-4xl md:text-5xl text-white mb-4">
              Join Our Pack
            </h2>
              ...
              <div className="max-w-md mx-auto">
                <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                  <input
                    ...
                    className="w-full px-6 py-4 rounded-full text-gray-900 focus:outline-none focus:ring-4 focus:ring-white/50 transition-all placeholder-gray-500 bg-white/95 backdrop-blur-sm"
                    required
                  />
                  <button 
                    type="submit"
                    disabled={isSubscribing}
                    className="bg-white text-purple-600 px-8 py-4 rounded-full font-semibold hover:bg-gray-100 transition-all duration-300 whitespace-nowrap disabled:opacity-70 disabled:cursor-not-allowed flex items-center space-x-2 transform hover:scale-105 active:scale-95 shadow-lg"
                  >
                    {isSubscribing ? (
                      <>
