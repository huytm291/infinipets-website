...
export default function Index() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              ...
              <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4">
                <button className="group bg-gradient-to-r from-yellow-400 to-pink-500 text-black font-bold px-8 py-4 rounded-full hover:shadow-2xl hover:scale-105 transition-all duration-300 flex items-center">
      ...
      <section className={`py-20 px-4 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-coiny text-4xl md:text-5xl mb-4 text-gradient">
      ...
      {/* Limited Edition - Updated to match Featured Favorites background */}
              ...
              <div key={product.id} className={`rounded-2xl overflow-hidden shadow-xl hover-lift ${isDarkMode ? 'bg-gray-700' : 'bg-white'}`}>
                <div className="md:flex">
                  ...
                  <div className="md:w-1/2 p-8 flex flex-col justify-center">
                    ...
                    <button className="bg-gradient-to-r from-yellow-400 to-pink-500 text-black font-bold px-6 py-3 rounded-full hover:shadow-xl hover:scale-105 transition-all duration-300 w-full">
                      Shop Now
                    </button>
                  </div>
                </div>
      ...
      {/* Newsletter Section - Updated button colors */}
      <section className={`py-20 ${isDarkMode ? 'bg-gray-900' : 'bg-white'} relative overflow-hidden`}>
        ...
        <div className="absolute top-20 right-20 w-16 h-16 bg-pink-200/20 dark:bg-pink-600/20 rounded-lg rotate-45 animate-bounce"></div>
        <div className="absolute bottom-10 left-20 w-24 h-24 bg-yellow-200/20 dark:bg-yellow-600/20 rounded-full animate-pulse"></div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-3xl mx-auto">
            <div className="mb-6">
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-800 dark:to-pink-800 rounded-full px-4 py-2 mb-4">
              ...
              <div className="max-w-md mx-auto">
                <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                  ...
                  <button 
                    ...
                    className="group bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-4 rounded-full font-semibold hover:from-purple-700 hover:to-blue-700 hover:shadow-xl transition-all duration-300 whitespace-nowrap disabled:opacity-70 disabled:cursor-not-allowed flex items-center space-x-2 transform hover:scale-105 active:scale-95"
                  >
                    {isSubscribing ? (
                      <>
      ...
      <footer className={`py-16 ${isDarkMode ? 'bg-black text-white' : 'bg-gray-900 text-white'}`}>
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="font-coiny text-2xl mb-4 text-gradient">INFINIPETS</h3>
