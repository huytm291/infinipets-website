...
export default function Index() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'bg-gray-900' : 'bg-gray-50'}`}>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {limitedProducts.map((product) => (
              <div key={product.id} className={`rounded-2xl overflow-hidden shadow-xl hover-lift ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
      ...
      {/* Newsletter Section - Updated to match Featured Favorites background */}
      <section className={`py-20 ${isDarkMode ? 'bg-gray-900' : 'bg-white'} relative overflow-hidden`}>
        ...
        <div className="absolute top-20 right-20 w-16 h-16 bg-yellow-400/20 rounded-lg rotate-45 animate-bounce"></div>
        <div className="absolute bottom-10 left-20 w-24 h-24 bg-pink-400/15 rounded-full animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-18 h-18 bg-green-400/20 rounded-lg rotate-12 animate-bounce"></div>

        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-3xl mx-auto">
            <div className="mb-6">
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-purple-500/10 to-pink-500/10 backdrop-blur-sm rounded-full px-4 py-2 mb-4">
                <Sparkles className="text-purple-600" size={16} />
                <span className={`text-sm font-medium ${isDarkMode ? 'text-purple-300' : 'text-purple-700'}`}>Join 50,000+ Pet Parents</span>
              </div>
            </div>
              ...
              <div className="max-w-md mx-auto">
                <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                  ...
                  <button 
                    ...
                    className="bg-gradient-to-r from-yellow-400 to-pink-500 text-black px-8 py-4 rounded-full font-semibold hover:from-yellow-500 hover:to-pink-600 transition-all duration-300 whitespace-nowrap disabled:opacity-70 disabled:cursor-not-allowed flex items-center space-x-2 transform hover:scale-105 active:scale-95 shadow-lg"
                  >
                    {isSubscribing ? (
                      <>
